...
Keystone is a deterministic execution vault that stores immutable evidence of every state transition and enables replay-verifiable truth, canonical artifact verification, and fail-closed verification.
