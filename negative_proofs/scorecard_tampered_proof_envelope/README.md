# Scorecard Tampered Proof Envelope Negative Proof
...
`go run ./cmd/keystone pipeline verify-proof --run-id scorecard_proof_9ad561d838321315 --run-root /tmp/keystone_negative_scorecard`
